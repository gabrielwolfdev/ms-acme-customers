package br.com.acme.application.entrypoint.consumer;

import br.com.acme.application.config.broker.KafkaConsumerConfig;
import br.com.acme.application.dataprovider.impl.event.record.common.DomainEventEnvelope;
