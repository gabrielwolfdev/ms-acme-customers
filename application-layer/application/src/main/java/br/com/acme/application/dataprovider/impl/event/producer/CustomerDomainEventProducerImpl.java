package br.com.acme.application.dataprovider.impl.event.producer;

import br.com.acme.application.dataprovider.impl.event.producer.converter.CustomerDomainEventConverter;
import br.com.acme.application.dataprovider.impl.event.record.CustomerDomainEventRecord;
import br.com.acme.application.dataprovider.impl.event.transactionaloutbox.TransactionalOutboxInstruction;
import br.com.acme.application.dataprovider.impl.event.transactionaloutbox.TransactionalOutboxMechanism;
import br.com.acme.application.dataprovider.impl.persistence.entity.CustomerEntity;
import br.com.acme.application.dataprovider.impl.persistence.entity.CustomerOutboxEntity;
