...
public class CleanArchitectureRuleSetTest {
    ...
    public static final String BASE_PACKAGE = "br.com.acme";
    ...
    private static final String ENTITY_PACKAGE = "br.com.acme.application.dataprovider.impl.persistence.entity..";
